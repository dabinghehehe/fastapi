from fastapi import Cookie, Request, Form

from models.base import User


async def home(req: Request, session_id: str = Cookie(None)):
    ...
    return req.app.state.views.TemplateResponse("index.html", {"request": req, **page_data})
